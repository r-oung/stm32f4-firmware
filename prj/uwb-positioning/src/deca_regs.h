...
#define SYS_CFG_RESET			0x00001200UL 	/* Reset value */
/*mask and shift */
...
#define TX_BUFFER_LEN   		(127)
#define TX_BUFFER_LEN_EXT		(1024)
...
#define AGC_STAT1_EDV2_MASK		0x0FF800		/* This 9-bit value relates to the input noise power measurement. */
...
#define GPIO_RXOKLED_EN			0x00000040UL 	/* Bit for selecting RXOKLED */
#define GPIO_SFDLED_EN			0x00000100UL    /* Bit for selecting SFDLED */
#define GPIO_RXLED_EN			0x00000400UL    /* Bit for selecting RXLED */
#define GPIO_TXLED_EN			0x00001000UL    /* Bit for selecting TXLED */
#define GPIO_EXTPA_EN			0x00004000UL    /* Bit for selecting EXTPA */
#define GPIO_EXTTXE_EN			0x00010000UL    /* Bit for selecting EXTTXE */
#define GPIO_EXTRXE_EN			0x00040000UL    /* Bit for selecting EXTRXE */
...
#define DRX_TUNE2_PAC08_PRF16 	0x311A002DUL
#define DRX_TUNE2_PAC08_PRF64 	0x313B006BUL
#define DRX_TUNE2_PAC16_PRF16 	0x331A0052UL
#define DRX_TUNE2_PAC16_PRF64 	0x333B00BEUL
#define DRX_TUNE2_PAC32_PRF16 	0x351A009AUL
#define DRX_TUNE2_PAC32_PRF64 	0x353B015EUL
#define DRX_TUNE2_PAC64_PRF16 	0x371A011DUL
#define DRX_TUNE2_PAC64_PRF64 	0x373B0296UL
...
/* offset from DRX_CONF_ID in bytes */
#define DRX_DRX_TUNE4H_OFFSET	0x26	/* 7.2.40.10 Sub-Register 0x27:26 – DRX_TUNE4H */
...
/* offset from TX_CAL_ID in bytes */
#define TC_SARC_OFFSET		    0x00         	/* SAR control */
#define TC_SARC_LEN 			(2)
#define TC_SARC_SAR_CTRL		0x01
 /* offset from TX_CAL_ID in bytes */
...
#define LDE_CFG2_PRF16 			0x1607
#define LDE_CFG2_PRF64 			0x0607
/* offset from LDE_IF_ID in bytes */
...
#define	PMSC_CTRL0_DEFAULT		0xF0300200UL	/* reset value of register PMSC_CTRL0 */
...
#define PMSC_CTRL0_ADCCE		0x00000400UL    /* ADC Clock Enable */
#define PMSC_CTRL0_AMCE 		0x00008000UL 	/* Accumulator memory clock Enable */
#define PMSC_CTRL0_GPCE 		0x00010000UL 	/* GPIO Clock Enable */
#define PMSC_CTRL0_GPRN 		0x00020000UL 	/* GPIO Reset */
#define PMSC_CTRL0_GPDCE 		0x00040000UL 	/* GPIO De-bounce Clock Enable */
#define PMSC_CTRL0_GPDRN 		0x00080000UL 	/* GPIO De-bounce Reset */
#define PMSC_CTRL0_KHZCLKEN		0x00800000UL 	/* Kiloherz Clock Enable*/
/* offset from PMSC_ID in bytes */
