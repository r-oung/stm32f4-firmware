/**
  ...
  *          performed in SDIO_PeriphInit() function declared in stm32f4_discovery.c
  *          file.
  *          You can easily tailor this driver to any other development board,
  *          by just adapting the defines for hardware resources and
  *          SDIO_PeriphInit() function.
  *
...
/** @defgroup SDSDIO_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup SDSDIO_Private_Variables
  * @{
  */
...
/** @defgroup SDSDIO_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup SDSDIO_Private_Functions
  * @{
  */
...
/**
  ...
  * @retval SD_Error: SD Card Error code.
  */
SD_Error SD_ReadMultiBlocks(uint8_t *readbuff, uint32_t ReadAddr, uint32_t BlockSize, uint32_t NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
  TransferError = SD_OK;
  TransferEnd = 0;
...
/**
  ...
  * @retval SD_Error: SD Card Error code.
  */
SD_Error SD_WriteMultiBlocks(uint8_t *writebuff, uint32_t WriteAddr, uint32_t BlockSize, uint32_t NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
...
{
  if(DMA_GetITStatus(SDIO_DMA_STREAM, SDIO_DMA_IT) != SET) return;
